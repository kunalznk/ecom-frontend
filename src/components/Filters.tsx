                ...
                <div className="shop-w">
                    ...
                    <div className="shop-w__wrap collapse show" id="s-rating">
                        <ul className="shop-w__list gl-scroll">
                            ...
                            // <li>
                            //     <div className="rating__check">
                            //         <input type="checkbox"  value={index+1} checked={filters.rating?.includes(rate)} onChange={(e) => handleChange(e)}/>
                            //         <div className="rating__check-star-wrap">
                            //             {new Array(5).fill(1).map((star, posn) => <i className={posn+1 <= index+1 ? "fas fa-star"  : "far fa-star"} />)}
                            //             </div>
                            //     </div>
                    ...
                    <div className="shop-w__wrap collapse show" id="s-price">
                        <form className="shop-w__form-p">
                            <div className="shop-w__form-p-wrap">
                                    ...
                                    <input className="input-text input-text--primary-style" type="text" id="price-min" placeholder="Min" value={filters?.price?.min} onChange={ (e) => dispatch(productActions.setFilter({price: { ...filters.price , min: +e.target.value}}))}/>
                                    </div>
                               
                                    <div>
                                    <label htmlFor="price-max"></label>
                                    <input className="input-text input-text--primary-style" type="text" id="price-max" placeholder="Max" value={filters?.price?.max} onChange={ (e) => dispatch(productActions.setFilter({price: { ...filters.price , max: +e.target.value}}))}/>
                                    </div>
