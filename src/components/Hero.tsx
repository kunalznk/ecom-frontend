...
const Hero = (props: any) => {
    return <>
     <Container maxWidth="xl" sx={{ padding: "20px", background: "url(https://images.unsplash.com/photo-1601924994987-69e26d50dc26?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=2670&q=80)", backgroundRepeat: "no-repeat" ,backgroundPosition:"center" , backgroundSize: "cover" }}>
            <Grid container {...props} >
                <Grid item>
                    <Grid container flexDirection="column" gap="10px" flexGrow={1}>
                ...
                <Link to="/products" style={{textDecoration: "none"}}><Button sx={{maxHeight:"62px" , maxWidth: "221px"}} variant="contained" >SHOP NOW</Button></Link>
