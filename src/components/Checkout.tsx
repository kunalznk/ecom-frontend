                        ...
                        <form className="checkout-f__delivery">
                            <div className="u-s-m-b-30">
                                ...
                                <div className="u-s-m-b-15">
                                    ...
                                    <label className="gl-label" htmlFor="billing-country">COUNTRY *</label><select className="select-box select-box--primary-style" id="billing-country" data-bill="">
                                ...
                                <div className="u-s-m-b-15">
                                    ...
                                    <label className="gl-label" htmlFor="billing-state">STATE/PROVINCE *</label><select className="select-box select-box--primary-style" id="billing-state" data-bill="">
