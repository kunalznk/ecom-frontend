                  ...
                  <li className="has-dropdown" data-tooltip="tooltip" data-placement="left" title="Account">
                    ...
                    <ul style={{ width: "120px" }}>
                      <li>
                        ...
                        <Link to="account"><i className="fas fa-user-circle u-s-m-r-6"></i>

                          <span>Account</span></Link></li>
                      
                      <li onClick={(e) =>{ alert("loggedOut");  localStorage.clear();}}>
                        <a><i className="fas fa-lock-open u-s-m-r-6"></i>
                        <span>Signout</span>
                        </a>
                      </li>
                    </ul>
              ...
              <div className="ah-lg-mode">
                ...
                <ul className="ah-list ah-list--design2 ah-list--link-color-secondary">
                  ...
                  <li>
                    ...
                    <Link to="/">VALUE OF THE DAY</Link></li>
                </ul>
