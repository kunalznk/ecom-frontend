                ...
                <div className="col-lg-12 col-md-12 u-s-m-b-30">
                    <div className="empty">
                        <div className="empty__wrap">
                            ...
                            <span className="empty__text-1">Your search, did not match any products. A partial match of your keywords is listed below.</span>

                            {/* <span className="empty__text-2">Related searches:
                            ...
                            <form className="empty__search-form">
                                ...
                                <input className="input-text input-text--primary-style" type="text" id="search-label" placeholder="Search Keywords" />
